...
/**
 * Builds and executes requests for operations under /api/admin/matches/invitations
 */
 ...
 */
export const InvitationsRequestBuilderUriTemplate = "{+baseurl}/api/admin/matches/invitations";
/**
