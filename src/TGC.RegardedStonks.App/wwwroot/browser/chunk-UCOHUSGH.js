...
// src/app/core/services/api-wrappers/admin-player-api.service.ts
var AdminPlayerApiService = class _AdminPlayerApiService {
  apiClient = inject(API_CLIENT);
  playersResource = resource({
    loader: () => this.apiClient.api.admin.players.get()
  });
  players = computed(() => this.playersResource.value()?.players ?? [], ...ngDevMode ? [{ debugName: "players" }] : []);
  isLoading = computed(() => this.playersResource.isLoading(), ...ngDevMode ? [{ debugName: "isLoading" }] : []);
  refresh() {
    this.playersResource.reload();
  }
  addPlayer(oid, userName) {
    return __async(this, null, function* () {
      yield this.apiClient.api.admin.players.post({ oid, userName });
      this.refresh();
    });
  }
  static \u0275fac = function AdminPlayerApiService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminPlayerApiService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AdminPlayerApiService, factory: _AdminPlayerApiService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminPlayerApiService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
function DataTable_For_2_th_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(column_r1.label);
  }
}
function DataTable_For_2_td_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const column_r1 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(row_r2[column_r1.key]);
  }
}
function DataTable_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0, 1);
    \u0275\u0275template(1, DataTable_For_2_th_1_Template, 2, 1, "th", 4)(2, DataTable_For_2_td_2_Template, 2, 1, "td", 5);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const column_r1 = ctx.$implicit;
    \u0275\u0275property("matColumnDef", column_r1.key);
  }
}
function DataTable_tr_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 8);
  }
}
function DataTable_tr_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 9);
  }
}
var DataTable = class _DataTable {
  ...
  columnKeys = computed(() => this.columns().map((column) => column.key), ...ngDevMode ? [{ debugName: "columnKeys" }] : []);
  static \u0275fac = function DataTable_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DataTable)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DataTable, selectors: [["app-data-table"]], inputs: { columns: [1, "columns"], rows: [1, "rows"] }, decls: 5, vars: 3, consts: [["mat-table", "", 1, "tgc-data-table", 3, "dataSource"], [3, "matColumnDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", "class", "tgc-mono-numeric", 4, "matCellDef"], ["mat-header-cell", ""], ["mat-cell", "", 1, "tgc-mono-numeric"], ["mat-header-row", ""], ["mat-row", ""]], template: function DataTable_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "table", 0);
      \u0275\u0275repeaterCreate(1, DataTable_For_2_Template, 3, 1, "ng-container", 1, _forTrack0);
      \u0275\u0275template(3, DataTable_tr_3_Template, 1, 0, "tr", 2)(4, DataTable_tr_4_Template, 1, 0, "tr", 3);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
  ...
  }, dependencies: [MatTableModule, MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow], styles: ["\n\n.tgc-data-table[_ngcontent-%COMP%] {\n  width: 100%;\n}\n/*# sourceMappingURL=data-table.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DataTable, [{
    type: Component,
    args: [{ selector: "app-data-table", imports: [MatTableModule], template: '<table mat-table [dataSource]="rows()" class="tgc-data-table">\n  @for (column of columns(); track column.key) {\n    <ng-container [matColumnDef]="column.key">\n      <th mat-header-cell *matHeaderCellDef>{{ column.label }}</th>\n      <td mat-cell *matCellDef="let row" class="tgc-mono-numeric">{{ row[column.key] }}</td>\n    </ng-container>\n  }\n\n  <tr mat-header-row *matHeaderRowDef="columnKeys()"></tr>\n  <tr mat-row *matRowDef="let row; columns: columnKeys()"></tr>\n</table>\n', styles: ["/* src/app/shared/components/data-table/data-table.scss */\n.tgc-data-table {\n  width: 100%;\n}\n/*# sourceMappingURL=data-table.css.map */\n"] }]
  }], null, { columns: [{ type: Input, args: [{ isSignal: true, alias: "columns", required: true }] }], rows: [{ type: Input, args: [{ isSignal: true, alias: "rows", required: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DataTable, { className: "DataTable", filePath: "src/app/shared/components/data-table/data-table.ts", lineNumber: 16 });
})();

// src/app/features/admin/admin-players-page/admin-players-page.ts
function AdminPlayersPage_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminPlayersPage_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-data-table", 4);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("columns", ctx_r0.columns)("rows", ctx_r0.rows());
  }
}
var PLAYER_COLUMNS = [
  { key: "id", label: "Id" },
...
var AdminPlayersPage = class _AdminPlayersPage {
  playerApi = inject(AdminPlayerApiService);
  dialog = inject(MatDialog);
  columns = PLAYER_COLUMNS;
  isLoading = this.playerApi.isLoading;
  rows = computed(() => this.playerApi.players().map((player) => ({
    id: player.id ?? "",
    oid: player.oid ?? "",
  ...
  static \u0275fac = function AdminPlayersPage_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminPlayersPage)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminPlayersPage, selectors: [["app-admin-players-page"]], decls: 13, vars: 1, consts: [[1, "admin-players-page"], [1, "admin-players-page-header"], ["mat-flat-button", "", 3, "click"], [1, "admin-players-page-loading"], [3, "columns", "rows"], ["diameter", "32"]], template: function AdminPlayersPage_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "section", 0)(1, "header", 1)(2, "div")(3, "h1");
      \u0275\u0275text(4, "All players");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p");
      \u0275\u0275text(6, "Every registered player is listed here for admin management.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "button", 2);
      \u0275\u0275listener("click", function AdminPlayersPage_Template_button_click_7_listener() {
        return ctx.openAddPlayerDialog();
      });
      \u0275\u0275elementStart(8, "mat-icon");
      \u0275\u0275text(9, "add");
      \u0275\u0275elementEnd();
      \u0275\u0275text(10, " Add player ");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(11, AdminPlayersPage_Conditional_11_Template, 2, 0, "div", 3)(12, AdminPlayersPage_Conditional_12_Template, 1, 2, "app-data-table", 4);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(11);
  ...
  }, dependencies: [MatButtonModule, MatButton, MatIconModule, MatIcon, MatProgressSpinnerModule, MatProgressSpinner, DataTable], styles: ["\n\n.admin-players-page[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 1.25rem;\n  padding: 1.5rem;\n}\n.admin-players-page-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 1rem;\n}\n.admin-players-page-header[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  margin: 0 0 0.25rem;\n}\n.admin-players-page-header[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n  color: var(--mat-sys-on-surface-variant);\n}\n.admin-players-page-loading[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  padding: 2rem;\n}\n/*# sourceMappingURL=admin-players-page.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminPlayersPage, [{
    type: Component,
    args: [{ selector: "app-admin-players-page", imports: [MatButtonModule, MatIconModule, MatProgressSpinnerModule, DataTable], template: '<section class="admin-players-page">\n  <header class="admin-players-page-header">\n    <div>\n      <h1>All players</h1>\n      <p>Every registered player is listed here for admin management.</p>\n    </div>\n    <button mat-flat-button (click)="openAddPlayerDialog()">\n      <mat-icon>add</mat-icon>\n      Add player\n    </button>\n  </header>\n\n  @if (isLoading()) {\n    <div class="admin-players-page-loading">\n      <mat-spinner diameter="32" />\n    </div>\n  } @else {\n    <app-data-table [columns]="columns" [rows]="rows()" />\n  }\n</section>\n', styles: ["/* src/app/features/admin/admin-players-page/admin-players-page.scss */\n.admin-players-page {\n  display: flex;\n  flex-direction: column;\n  gap: 1.25rem;\n  padding: 1.5rem;\n}\n.admin-players-page-header {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 1rem;\n}\n.admin-players-page-header h1 {\n  margin: 0 0 0.25rem;\n}\n.admin-players-page-header p {\n  margin: 0;\n  color: var(--mat-sys-on-surface-variant);\n}\n.admin-players-page-loading {\n  display: flex;\n  justify-content: center;\n  padding: 2rem;\n}\n/*# sourceMappingURL=admin-players-page.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminPlayersPage, { className: "AdminPlayersPage", filePath: "src/app/features/admin/admin-players-page/admin-players-page.ts", lineNumber: 30 });
})();
export {
  AdminPlayersPage
};
//# sourceMappingURL=chunk-UCOHUSGH.js.map
