...
// src/app/shared/components/form-dialog/form-dialog.ts
var _forTrack0 = ($index, $item) => $item.key;
function FormDialog_For_5_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function FormDialog_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-form-field", 3)(1, "mat-label");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, FormDialog_For_5_Conditional_3_Template, 2, 0, "span", 9);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(field_r1.type === "currency" ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("type", field_r1.type === "text" ? "text" : "number")("formControlName", field_r1.key)("placeholder", field_r1.placeholder ?? "");
  }
}
function FormDialog_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function FormDialog_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 8);
  }
}
function FormDialog_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275textInterpolate1(" ", ctx_r1.data.submitLabel ?? "Submit", " ");
  }
}
var FormDialog = class _FormDialog {
  dialogRef = inject(MatDialogRef);
  data = inject(MAT_DIALOG_DATA);
  submitting = signal(false, ...ngDevMode ? [{ debugName: "submitting" }] : []);
  error = signal(null, ...ngDevMode ? [{ debugName: "error" }] : []);
  form = new FormGroup(Object.fromEntries(this.data.fields.map((field) => {
    const validators = [];
    if (field.required)
      validators.push(Validators.required);
    if (field.type !== "text" && field.min !== void 0)
      validators.push(Validators.min(field.min));
    return [field.key, new FormControl(field.type === "text" ? "" : null, { validators })];
  })));
  submit() {
    return __async(this, null, function* () {
      ...
      this.error.set(null);
      try {
        const result = yield this.data.submit(this.form.getRawValue());
  ...
  static \u0275fac = function FormDialog_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _FormDialog)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FormDialog, selectors: [["app-form-dialog"]], decls: 13, vars: 7, consts: [["mat-dialog-title", ""], [3, "ngSubmit", "formGroup"], [1, "form-dialog-content"], ["appearance", "outline", 1, "form-dialog-field"], [1, "form-dialog-error"], ["align", "end"], ["mat-button", "", "type", "button", 3, "click", "disabled"], ["mat-flat-button", "", "type", "submit", 3, "disabled"], ["diameter", "18"], ["matTextPrefix", ""], ["matInput", "", 3, "type", "formControlName", "placeholder"]], template: function FormDialog_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "h2", 0);
      \u0275\u0275text(1);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(2, "form", 1);
      \u0275\u0275listener("ngSubmit", function FormDialog_Template_form_ngSubmit_2_listener() {
        return ctx.submit();
      });
      \u0275\u0275elementStart(3, "mat-dialog-content", 2);
      \u0275\u0275repeaterCreate(4, FormDialog_For_5_Template, 5, 5, "mat-form-field", 3, _forTrack0);
      \u0275\u0275conditionalCreate(6, FormDialog_Conditional_6_Template, 2, 1, "p", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "mat-dialog-actions", 5)(8, "button", 6);
      \u0275\u0275listener("click", function FormDialog_Template_button_click_8_listener() {
        return ctx.cancel();
      });
      \u0275\u0275text(9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "button", 7);
      \u0275\u0275conditionalCreate(11, FormDialog_Conditional_11_Template, 1, 0, "mat-spinner", 8)(12, FormDialog_Conditional_12_Template, 1, 1);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      ...
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.data.fields);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.error() ? 6 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275property("disabled", ctx.submitting());
      \u0275\u0275advance();
      \u0275\u0275textInterpolate(ctx.data.cancelLabel ?? "Cancel");
      \u0275\u0275advance();
      \u0275\u0275property("disabled", ctx.submitting());
      \u0275\u0275advance();
    ...
    MatProgressSpinner
  ], styles: ["\n\n.form-dialog-content[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.25rem;\n  min-width: 320px;\n}\n.form-dialog-field[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.form-dialog-error[_ngcontent-%COMP%] {\n  margin: 0;\n  color: var(--tgc-down);\n  font-size: 0.875rem;\n}\n/*# sourceMappingURL=form-dialog.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FormDialog, [{
    type: Component,
    args: [{ selector: "app-form-dialog", imports: [
      ReactiveFormsModule,
      MatDialogTitle,
      MatDialogContent,
      MatDialogActions,
...
<form [formGroup]="form" (ngSubmit)="submit()">
  <mat-dialog-content class="form-dialog-content">
    @for (field of data.fields; track field.key) {
      <mat-form-field appearance="outline" class="form-dialog-field">
        <mat-label>{{ field.label }}</mat-label>
        @if (field.type === 'currency') {
          <span matTextPrefix>$&nbsp;</span>
        }
        <input matInput [type]="field.type === 'text' ? 'text' : 'number'" [formControlName]="field.key" [placeholder]="field.placeholder ?? ''" />
      </mat-form-field>
    }
    @if (error()) {
      <p class="form-dialog-error">{{ error() }}</p>
    }
  </mat-dialog-content>
  <mat-dialog-actions align="end">
    <button mat-button type="button" [disabled]="submitting()" (click)="cancel()">{{ data.cancelLabel ?? 'Cancel' }}</button>
...
`, styles: ["/* src/app/shared/components/form-dialog/form-dialog.scss */\n.form-dialog-content {\n  display: flex;\n  flex-direction: column;\n  gap: 0.25rem;\n  min-width: 320px;\n}\n.form-dialog-field {\n  width: 100%;\n}\n.form-dialog-error {\n  margin: 0;\n  color: var(--tgc-down);\n  font-size: 0.875rem;\n}\n/*# sourceMappingURL=form-dialog.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FormDialog, { className: "FormDialog", filePath: "src/app/shared/components/form-dialog/form-dialog.ts", lineNumber: 49 });
})();
...
//# sourceMappingURL=chunk-MA2UHM4Z.js.map
